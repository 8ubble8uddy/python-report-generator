...
```
Чтобы добавить новый отчёт, необходимо прописать его в файле reports.json
```
"new_report": {
  "name": "Человекочитаемое название отчёта",
  "description": "Описание отчёта",
  "ddl": "SQL-запрос или путь к файлу для создание таблицы",
  "sql": "SQL-запрос или путь к файлу для получения отчёта"
}
```
